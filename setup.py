...
setuptools.setup(
    ...
    python_requires=">=3, <4",
    install_requires=[
       'torch @ https://wayve-data.s3.eu-west-2.amazonaws.com/public/installers/torch-1.8.1-cp37-cp37m-linux_x86_64-cuda-11.0.3-cudnn8-intel-mkl-2020.4-912.whl#egg=torch-1.8.1'
    ],
    # Package description
