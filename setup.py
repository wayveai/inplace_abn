...
setuptools.setup(
    ...
    python_requires=">=3, <4",
    install_requires=[
       'torch @ https://wayve-data.s3.eu-west-2.amazonaws.com/public/installers/torch-1.8.1-0.py37.cuda110.nompi.mkl202004912.py3-none-manylinux2014_x86_64.whl#egg=torch-1.8.1'
    ],
    # Package description
